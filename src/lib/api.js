...
export const verifyResetToken = (token)                       => post('/api/reset-token',           { token })
export const consumeResetToken= (token)                       => post('/api/reset-token',           { token, action: 'consume' })
export const getAlert         = ()                            => get('/api/alert')
export const updateEmail      = (username, newEmail)           => post('/api/update-email',           { username, newEmail })
export const adminLogin       = (username, password, totpToken) => post('/api/admin/login',           { username, password, totpToken })
